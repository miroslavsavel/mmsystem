<!-- Contains the form for creating and editing user accounts. -->

<?php include('../../config.php'); ?>
<?php include(INCLUDE_PATH . '/logic/common_functions.php') ?>
<?php include(ROOT_PATH . '/admin/users/userLogic.php'); ?>

<!-- method getAllRoles(). We need this method because,
 in order to create an admin user, we need to select a role from 
 the list of all the roles in the database to assign to this user. 
So we will get all roles from the database and populate them on an option-select field in the form.

this method is defined in userLogic.php
-->
