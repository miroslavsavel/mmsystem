<!-- 
    ADMIN area
The dashboard.php is the admin area, right? 
It is not supposed to be accessed by ordinary users. 
So we need to redirect any normal user attempting to visit this page back to the homepage.
Also, we are not yet creating/managing admin users and roles. All of that is coming soon. -->
